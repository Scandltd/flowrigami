...
export default class Catching extends Node {
  name = 'Catching';
  ...
  private pentagon: Envelope;
  private pentagonPreview: Envelope;
  ...
  constructor(ctx: CanvasRenderingContext2D, coordinates: Coordinates, radius?: number) {
    ...
    this.pentagon = new Envelope(canvas, tmpHookDiv, innerFigureStyle, pentagonParams);
    this.pentagonPreview = new Envelope(canvas, tmpHookDiv, innerFigureStyle, pentagonPreviewParams);
