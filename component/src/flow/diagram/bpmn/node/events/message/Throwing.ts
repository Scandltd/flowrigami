...
import EnvelopeFill from '@app/flow/diagram/bpmn/shapes/EnvelopeFill';
...
export default class Throwing extends BpmnNode {
  ...
  private envelopeFill: EnvelopeFill;
  private envelopeFillPreview: EnvelopeFill;
  ...
  constructor(ctx: CanvasRenderingContext2D, coordinates: Coordinates, radius?: number) {
    ...
    const envelopeFillPreviewParams = {
      x: coordinates.x,
      y: coordinates.y,
      width: 9,
      height: 5,
    ...
    this.envelopeFill = new EnvelopeFill(canvas, tmpHookDiv, innerFigureStyle, envelopeFillParams);
    this.envelopeFillPreview = new EnvelopeFill(canvas, tmpHookDiv, innerFigureStyle, envelopeFillPreviewParams);
  ...
  public drawPreview() {
    ...
    this.envelopeFillPreview.isHover = this.isHover;

    this.circlePreview.draw();
    this.innerCirclePreview.draw();
    this.envelopeFillPreview.draw();
  }
