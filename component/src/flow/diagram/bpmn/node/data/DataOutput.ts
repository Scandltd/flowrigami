...
export default class DataOutput extends Node {
  name = 'DataOutput';
  ...
  constructor(ctx: CanvasRenderingContext2D, coordinates: Coordinates, halfWidth?: number, halfHeight?: number) {
    ...
    this.arrow = new Arrow(canvas, tmpHookDiv, innerFigureFillStyle, arrowParams);
    this.arrowPreview = new Arrow(canvas, tmpHookDiv, innerFigureFillStyle, arrowPreviewParams);
