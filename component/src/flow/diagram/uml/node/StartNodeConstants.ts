import {
  ...
  START_NODE_BACKGROUND_COLOR,
  START_NODE_BORDER_COLOR,
...
export const styles: ShapeStyle = {
  background: {
    color: START_NODE_BACKGROUND_COLOR,
  },
  border: {
    color: START_NODE_BORDER_COLOR,
    style: 'solid',
...
styles.hover = {
  ...
  border: {
    ...styles.border!,
    color: START_NODE_BORDER_COLOR_HOVER,
  },
};
styles.active = {
  ...styles,
  border: {
    ...styles.border!,
    color: START_NODE_BORDER_COLOR_ACTIVE,
  },
};
